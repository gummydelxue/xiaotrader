...
DEMO_ACCOUNT = "213446928"  # Your demo account number
DEMO_PASSWORD = "h3qJy$2A"  # Your demo account password
DEMO_SERVER = "OctaFX-Demo"  # Your demo server name (e.g., "ICMarkets-Demo")
